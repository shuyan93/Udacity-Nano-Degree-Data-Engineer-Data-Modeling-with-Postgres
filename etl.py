...
def process_song_file(cur, filepath):
    """
    Processes a single song file from the directory and load into database(song and artist tables)   
...
def process_log_file(cur, filepath):
    """
    Processes a single log file from the directory and load into database (time, user, songplay_data tables)  
    :param cur: the database cursor
...
def process_data(cur, conn, filepath, func):
    """
    Extracts all log and song files from directory and prints the number of files processed
    :param cur: the database cursor
